...
return [
    ...
    'custom' => [
        ...
        'contacts.*.full_name' => [
            'required_with' => 'The contact full name is required when contact information is filled in.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'contacts.*.full_name' => 'contact full name',
        'contacts.*.position' => 'contact position or grade',
        ...
        'expiration_date' => 'offer validity',
        'id_nat' => 'national ID',
        'logo' => 'logo',
        'name' => 'name',
        'nif' => 'tax ID',
