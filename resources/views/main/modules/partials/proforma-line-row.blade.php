@php
    ...
    $lineType = $line['line_type'] ?? \App\Models\AccountingProformaInvoiceLine::TYPE_FREE;
    $discountType = $line['discount_type'] ?? \App\Models\AccountingProformaInvoiceLine::DISCOUNT_FIXED;
@endphp
...
<div class="proforma-line-card" data-proforma-line-row>
    <div class="row g-3 align-items-end">
        ...
        <div class="col-lg-3 col-md-8" data-proforma-item-field @hidden($lineType !== \App\Models\AccountingProformaInvoiceLine::TYPE_ITEM)>
        ...
        <div class="col-lg-3 col-md-8" data-proforma-service-field @hidden($lineType !== \App\Models\AccountingProformaInvoiceLine::TYPE_SERVICE)>
        ...
        <div class="col-lg-2 col-md-3">
            ...
            <select name="lines[{{ $index }}][discount_type]" class="form-select @error("lines.$index.discount_type") is-invalid @enderror" data-proforma-discount-type>
                <option value="{{ \App\Models\AccountingProformaInvoiceLine::DISCOUNT_FIXED }}" @selected($discountType === \App\Models\AccountingProformaInvoiceLine::DISCOUNT_FIXED)>{{ __('main.discount_fixed') }}</option>
                <option value="{{ \App\Models\AccountingProformaInvoiceLine::DISCOUNT_PERCENT }}" @selected($discountType === \App\Models\AccountingProformaInvoiceLine::DISCOUNT_PERCENT)>{{ __('main.discount_percent') }}</option>
            </select>
