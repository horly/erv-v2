@php
    $lineType = $line['line_type'] ?? \App\Models\AccountingPurchaseLine::TYPE_FREE;
    $discountType = $line['discount_type'] ?? \App\Models\AccountingPurchaseLine::DISCOUNT_FIXED;
@endphp
...
<div class="proforma-line-card" data-proforma-line-row>
    <div class="row g-3 align-items-start">
        ...
        <div class="col-lg-3 col-md-8" data-proforma-item-field @hidden($lineType !== \App\Models\AccountingPurchaseLine::TYPE_ITEM)>
        ...
        <div class="col-lg-3 col-md-8" data-proforma-service-field @hidden($lineType !== \App\Models\AccountingPurchaseLine::TYPE_SERVICE)>
        ...
        <div class="col-lg-1 col-md-2">
            <button type="button" class="icon-light-button proforma-line-remove" data-remove-proforma-line aria-label="{{ __('admin.delete') }}">
        ...
        <div class="col-lg-2 col-md-3">
            <label class="form-label">{{ __('main.purchase_unit_price') }} *</label>
        ...
        <div class="col-lg-2 col-md-3">
            ...
            <select name="lines[{{ $index }}][discount_type]" class="form-select @error("lines.$index.discount_type") is-invalid @enderror" data-proforma-discount-type>
                <option value="{{ \App\Models\AccountingPurchaseLine::DISCOUNT_FIXED }}" @selected($discountType === \App\Models\AccountingPurchaseLine::DISCOUNT_FIXED)>{{ __('main.discount_fixed') }}</option>
                <option value="{{ \App\Models\AccountingPurchaseLine::DISCOUNT_PERCENT }}" @selected($discountType === \App\Models\AccountingPurchaseLine::DISCOUNT_PERCENT)>{{ __('main.discount_percent') }}</option>
            </select>
        ...
        <div class="col-lg-4" data-proforma-create-item-field @hidden($lineType !== \App\Models\AccountingPurchaseLine::TYPE_FREE)>
            <label class="form-check customer-order-stock-check">
                <input type="hidden" name="lines[{{ $index }}][create_stock_item]" value="0">
                <input type="checkbox" name="lines[{{ $index }}][create_stock_item]" value="1" @checked((bool) ($line['create_stock_item'] ?? false))>
                <span>{{ __('main.create_stock_item_from_free_line') }}</span>
            </label>
        </div>
    </div>
</div>
