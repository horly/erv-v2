...
use App\Http\Controllers\GmaoController;
...
Route::controller(MainController::class)->group(function (): void {
    ...
    Route::middleware(['auth', 'accounting.menu'])->group(function (): void {
        ...
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao', [GmaoController::class, 'dashboard'])->name('main.gmao.dashboard');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/equipment', [GmaoController::class, 'equipment'])->name('main.gmao.equipment');
        Route::post('/main/companies/{company}/sites/{site}/modules/gmao/equipment', [GmaoController::class, 'storeEquipment'])->name('main.gmao.equipment.store');
        Route::put('/main/companies/{company}/sites/{site}/modules/gmao/equipment/{equipment}', [GmaoController::class, 'updateEquipment'])->name('main.gmao.equipment.update');
        Route::delete('/main/companies/{company}/sites/{site}/modules/gmao/equipment/{equipment}', [GmaoController::class, 'destroyEquipment'])->name('main.gmao.equipment.destroy');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/equipment-categories', [GmaoController::class, 'equipmentCategories'])->name('main.gmao.equipment-categories');
        Route::post('/main/companies/{company}/sites/{site}/modules/gmao/equipment-categories', [GmaoController::class, 'storeEquipmentCategory'])->name('main.gmao.equipment-categories.store');
        Route::put('/main/companies/{company}/sites/{site}/modules/gmao/equipment-categories/{category}', [GmaoController::class, 'updateEquipmentCategory'])->name('main.gmao.equipment-categories.update');
        Route::delete('/main/companies/{company}/sites/{site}/modules/gmao/equipment-categories/{category}', [GmaoController::class, 'destroyEquipmentCategory'])->name('main.gmao.equipment-categories.destroy');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/locations', [GmaoController::class, 'locations'])->name('main.gmao.locations');
        Route::post('/main/companies/{company}/sites/{site}/modules/gmao/locations', [GmaoController::class, 'storeLocation'])->name('main.gmao.locations.store');
        Route::put('/main/companies/{company}/sites/{site}/modules/gmao/locations/{location}', [GmaoController::class, 'updateLocation'])->name('main.gmao.locations.update');
        Route::delete('/main/companies/{company}/sites/{site}/modules/gmao/locations/{location}', [GmaoController::class, 'destroyLocation'])->name('main.gmao.locations.destroy');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/requests', [GmaoController::class, 'requests'])->name('main.gmao.requests');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/work-orders', [GmaoController::class, 'workOrders'])->name('main.gmao.work-orders');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/preventive', [GmaoController::class, 'preventive'])->name('main.gmao.preventive');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/maintenance-routes', [GmaoController::class, 'maintenanceRoutes'])->name('main.gmao.maintenance-routes');
        Route::post('/main/companies/{company}/sites/{site}/modules/gmao/maintenance-routes', [GmaoController::class, 'storeMaintenanceRoute'])->name('main.gmao.maintenance-routes.store');
        Route::put('/main/companies/{company}/sites/{site}/modules/gmao/maintenance-routes/{route}', [GmaoController::class, 'updateMaintenanceRoute'])->name('main.gmao.maintenance-routes.update');
        Route::delete('/main/companies/{company}/sites/{site}/modules/gmao/maintenance-routes/{route}', [GmaoController::class, 'destroyMaintenanceRoute'])->name('main.gmao.maintenance-routes.destroy');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/technicians', [GmaoController::class, 'technicians'])->name('main.gmao.technicians');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/spare-parts', [GmaoController::class, 'spareParts'])->name('main.gmao.spare-parts');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/traceability', [GmaoController::class, 'traceability'])->name('main.gmao.traceability');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/reports', [GmaoController::class, 'reports'])->name('main.gmao.reports');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/reports/pdf', [GmaoController::class, 'printReport'])->name('main.gmao.reports.pdf');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/notifications', [GmaoController::class, 'notifications'])->name('main.gmao.notifications');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/notifications/{notification}', [GmaoController::class, 'showNotification'])->name('main.gmao.notifications.show');
        Route::get('/main/companies/{company}/sites/{site}/modules/gmao/settings', [GmaoController::class, 'settings'])->name('main.gmao.settings');
